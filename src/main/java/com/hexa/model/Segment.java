...
//-------------------------------------------------------------------------------------------------------------------------
	...
	/**
	 * Retourne True si le Segment et l'Object donné en paramètre sont égaux : égaux
	 * si l'objet est de la classe Segment et a la même origine et destination que
	 * le Segment appelant
	 * 
	 * @param obj
	 * @return boolean
